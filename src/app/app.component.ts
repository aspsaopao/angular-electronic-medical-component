...
import { DocumentFormat } from './ele/types/documentFormat';
import { OptionsEx } from './ele/types/eleeditinterface';
...
export class AppComponent {
  ...
  sss(v:any)
  {
    this.editOption.replic(this.editOption.documentContent, DocumentFormat.Rtf);
  }
}
